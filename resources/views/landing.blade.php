<x-main title="Home">
    ...
    <div class=" container container--narrow   main-container d-flex flex-column align-items-center ">
        <div class="border banner-top w-100">
        ...
        <div class="center-content d-flex w-100 justify-content-between mt-5">
            ...
            <div class="d-flex flex-wrap center-content-right w-50">
                <div class="card d-flex flex-column align-items-center service-card mx-2 my-3 text-center">
                    <img  src={{ asset('images/iconmonstr-browser-lined.svg') }} alt="" width="175px">
                   <h4>Full Customization</h4>
                </div>
                <div class="card d-flex flex-column align-items-center service-card mx-2 my-3 text-center">
                    <img class="my-4" src={{ asset('images/iconmonstr-smartphone-16.svg') }} alt="" width="125px">
                   <h4>Responsive Design</h4>
                </div>
                <div class="card d-flex flex-column align-items-center service-card mx-2  text-center">
                    <img src={{ asset('images/iconmonstr-magnifier-lined.svg') }} alt="" width="175px">
                   <h4>Enhanced SEO</h4>
                </div>
                <div class="card d-flex flex-column align-items-center service-card mx-2 text-center">
                    <img  src={{ asset('images/iconmonstr-browser-lined.svg') }} alt="" width="175px">
